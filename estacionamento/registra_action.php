<?php
    ...
    if($cliente && $contato && $tipo && $placa && $marca && $modelo && $data && $hora) {
        ...
        $sql = $pdo->prepare("INSERT INTO tbl_cliente (nome, contato)VALUES(:nome, :contato);INSERT INTO tbl_veiculo (tipo, placa, marca, modelo)
        VALUES(:tipo, :placa, :marca, :modelo);INSERT INTO tbl_estacionamento (data, hora) VALUES(:data, :hora);"
    );
